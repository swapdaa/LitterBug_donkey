    ...
    def update(self):
        ...
        * cross = PS3 cross => decrease max throttle
        ...
        while self.running:
            ...
            #    print("I'm button tl2!")

            #if button == 'tr2' and button_state == 1:
            #    print("I'm button tr2!")

            #if button == 'select' and button_state == 1:
            #    print("I'm button select!")

            #if button == 'start' and button_state == 1:
            #    print("I'm button start!")

            #if button == 'thumbl' and button_state == 1:
            #    print("I'm button thumbl!")

            #if button == 'thumbr' and button_state == 1:
            #    print("I'm button thumbr!")
